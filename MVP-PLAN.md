...
Profiles hold identity and display name. Leagues hold name, season, commissioner and a random invite code. Memberships link profiles to leagues. Games hold season/week, two team identifiers, UTC kickoff, status and winner. Picks uniquely link league, user and game.
...
5. Add commissioner controls for member management and automatic result synchronization.
...
## Official schedule and live integration

The official schedule uses stable provider IDs, normalized UTC dates, real bye weeks, and refreshed kickoffs. Display kickoff in the viewer’s time zone and never trust browser-reported outcomes.
